...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      <div className="absolute inset-0 bg-gradient-to-br from-red-600/20 via-black to-orange-600/20"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        <div className="mb-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            <span className="text-white font-semibold">Try DigiChakra360 FREE for 3 Days!</span><br />
            Experience real marketing results with our data-driven digital strategies — zero risk, all reward.
          </p>

          <button
            onClick={scrollToSignup}
            className="group bg-gradient-to-r from-red-600 to-orange-600 text-white px-10 py-5 rounded-full text-xl font-bold hover:from-red-700 hover:to-orange-700 transition-all duration-300 shadow-2xl hover:shadow-red-500/50 hover:scale-105 inline-flex items-center gap-3"
          >
        ...
        <div className="mt-16 relative">
          <div className="absolute inset-0 bg-gradient-to-t from-red-600/30 to-transparent blur-3xl"></div>
          <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 shadow-2xl max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl mx-auto mb-3 flex items-center justify-center shadow-lg">
